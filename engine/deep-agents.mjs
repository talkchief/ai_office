...
export class OfficeEngine {
  ...
  // Settings → Office → "Ask before outside actions": off, and Vault actions, connector tools and Brain note updates run at once.
  asksApproval() { return this.settings().approvals !== false; }
