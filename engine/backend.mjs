...
// Long-term memory (office-memory.mjs) mounts under /memories/: the Program Manager gets the company pages, a team gets its own
// page, everyone gets shared notes. The routes come from OfficeMemory.routesFor(role) so a lead's file system never holds another team.
export function officeBackend({ workspaceDir, knowledgeDir, skillDirs = {}, memoryRoutes = {} }) {
  ...
  Object.assign(routes, memoryRoutes);
