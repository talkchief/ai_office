...
- **The Agency.** 260+ open-source specialist personas (MIT) ship with the office. Hire one onto a team from Settings, or take just its method as a skill.
- **The Program Manager plans and reads skills.** Every task starts with a plan (Deep Agents' task list, shown on the task page); the Program Manager reads project-management skills on demand, including the office's running-a-task and cross-team-handoff methods.
