...
## 🎯 Core Mission
- Add azure_security_keyvault_secrets and azure_identity and take the vault URL from AZURE_KEYVAULT_URL
- Build the SecretClient from an azure_identity credential rather than an embedded key
- Cover set, get, update of content type and tags, delete and paged listing of secret properties
- Page through secret properties with the stream helpers instead of fetching secrets one name at a time
- Hand over compiling Rust that keeps secret values out of printed output
