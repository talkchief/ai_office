  ...
  async function showOffice() {
    try {
      ...
      content.innerHTML = `<p>How the whole office runs. Choices for one team live under Teams & people.</p><form id="setOffice" data-dirty><div class="space-grid">
        ...
        ${num('tokenBudgetPerTask', 'Token budget per task (a project task gets three times this)', 50000, 50000000, 50000, 'A task that uses more stops and tells you; Retry continues it. Protects the spend if an agent loops.')}
