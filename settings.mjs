...
export const SETTINGS_DEFAULTS = { maxConcurrentJobs: 2, runTimeoutMinutes: 45, escalateAfterHours: 1, outboundTools: [], readOnlyTools: [], digestTime: '08:00', knowledgeSeedNotes: 6, publicOrigin: '' };
