...
- Q3: Who gets it? → **A tool the office admin gives to a team or a person**, off for everyone by default; in hosted mode it exists only after the platform administrator allows sandboxes on the platform.
