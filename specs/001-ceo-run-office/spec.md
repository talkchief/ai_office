...
**Acceptance Scenarios**:
1. **Given** Settings → Teams, **When** the CEO adds a team or an agent, **Then** it is saved with validation (1–10 teams, 2–7 agents per team: a lead and up to six specialists) and appears in the office on the next page load without a restart.
