...
**Acceptance Scenarios**:
1. **Given** Settings → Teams, **When** the CEO adds a team or an agent, **Then** it is saved with validation (1–10 teams, 2–12 agents per team including one lead) and appears in the office on the next page load without a restart.
